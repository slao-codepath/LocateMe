...
public class MeetupMapFragment extends Fragment {
    ...
    private final Meetup meetup = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (meetupId > 0) {
            // TODO fix
            //            meetup = Meetup.byObjectId(meetupId, Meetup.class);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (meetup != null) {
            ...
            //TODO fix
            //            List<UserMeetupState> states = UserMeetupState.byMeetupId(meetup.getObjectId());
            List<UserMeetupState> states = new ArrayList<UserMeetupState>();

            for (UserMeetupState state : states) {
                User.byObjectId(state.userId, User.class, new GetSingleObjectListener<User>() {
                    @Override
